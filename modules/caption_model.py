...
class CaptionModel(nn.Module):
    ...
    def beam_search(self, init_state, init_logprobs, *args, **kwargs):
        ...
        opt = kwargs['opt']
        temperature = getattr(opt, 'temperature', 1)  # This should not affect beam search, but will affect dbs
        ...
        suppress_UNK = getattr(opt, 'suppress_UNK', 0)
        length_penalty = utils.penalty_builder(getattr(opt, 'length_penalty', ''))
