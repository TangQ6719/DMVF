...
from modules.Transformer import MultiHeadedAttention, PositionalEncoding, PositionwiseFeedForward, Encoder, \
    EncoderLayer_grid, EncoderLayer_reg, Embeddings, SublayerConnection, clones
...
class TextEncoder(nn.Module):
    def __init__(self, d_model, d_ff, num_layers, tgt_vocab, num_labels=14, h=3, dropout=0.1):
        ...
        self.encoder = Encoder(EncoderLayer_grid(d_model, attn, ff, dropout), num_layers, EncoderLayer_reg(d_model, attn, ff, dropout), num_layers)
