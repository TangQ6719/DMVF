...
from .datasets import IuxrayMultiImageDataset, MimiccxrSingleImageDataset, CovidSingleImageDataset, covSingleImageDataset
...
class LADataLoader(DataLoader):
    def __init__(self, args, tokenizer, split, shuffle):
        ...
        elif self.dataset_name == 'cov':
            self.dataset = covSingleImageDataset(self.args, self.tokenizer, self.split, transform=self.transform)
        else:
